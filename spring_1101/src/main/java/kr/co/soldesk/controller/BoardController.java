...
public class BoardController {
	...
	@GetMapping("/main")
	public String main(@RequestParam("board_info_idx") int board_info_idx, Model model) { //a태그로 넘겨서 @RequestParam으로 받음
	...
	public String read(@RequestParam("board_info_idx") int board_info_idx,
		...
		model.addAttribute("readContentBean", readContentBean); //상세정보
		model.addAttribute("content_idx", content_idx); //수정할 글의 인덱스 번호 호출
	...
	public String write(@ModelAttribute("writeContentBean") ContentBean writeContentBean,
						@RequestParam("board_info_idx") int board_info_idx) { //set
		writeContentBean.setContent_board_idx(board_info_idx);
		
		return "board/write";
	}
	@PostMapping("/write_pro")
	public String write_pro(@Valid @ModelAttribute("writeContentBean") ContentBean writeContentBean, BindingResult result) { //get
	...
	public String modify(@RequestParam("board_info_idx") int board_info_idx,
		...
		modifyContentBean.setContent_board_idx(board_info_idx); //param 값 그대로 저장 
		modifyContentBean.setContent_idx(content_idx); // param 값 그대로 저장
